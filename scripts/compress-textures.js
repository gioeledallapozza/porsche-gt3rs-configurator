...
const RAW_DIR = path.resolve(__dirname, '../_raw_assets/textures/aluminium'); //to change for other textures
const OUT_DIR = path.resolve(__dirname, '../public/textures/materials/aluminium'); //to change for other textures
