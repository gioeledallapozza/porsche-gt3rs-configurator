...
const RAW_DIR = path.resolve(__dirname, '../_raw_assets/textures/ambient_occlusion'); //to change for other textures
const OUT_DIR = path.resolve(__dirname, '../public/textures/materials/ambient_occlusion'); //to change for other textures
