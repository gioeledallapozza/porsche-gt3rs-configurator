...
const RAW_DIR = path.resolve(__dirname, '../_raw_assets/textures/leather'); //to change for other textures
const OUT_DIR = path.resolve(__dirname, '../public/textures/materials/leather'); //to change for other textures
